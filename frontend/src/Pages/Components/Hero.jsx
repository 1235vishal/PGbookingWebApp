...
//             </div>
//             <div className="stat-item">
//               <span className="stat-number">642</span>
...
import { FaArrowRight, FaBroom, FaDoorOpen, FaExpandArrowsAlt, FaMedkit, FaSearch, FaShieldAlt, FaUmbrella, FaUtensils, FaWifi } from 'react-icons/fa';
import { Link } from 'react-router-dom';
import './Styles/Hero.css';
      ...
      <div className="features-bar">
        ...
        <div className="feature-row">
          <div className="feature-item">
            ...
            <h3 className="feature-title">Open Terrace</h3>
            <p className="feature-text">Relaxing outdoor space</p>
          </div>
          <div className="feature-item">
            <div className="feature-icon">
              <FaDoorOpen />
            </div>
            <h3 className="feature-title">Separate Rooms</h3>
            <p className="feature-text">Privacy guaranteed</p>
          </div>
          <div className="feature-item">
            <div className="feature-icon">
              <FaExpandArrowsAlt />
            ...
            <p className="feature-text">Comfortable living area</p>
          </div>
          <div className="feature-item">
            <div className="feature-icon">
              <FaMedkit />
            </div>
            <h3 className="feature-title">Medical Help</h3>
            <p className="feature-text">Emergency assistance</p>
          </div>
        </div>
      </div>
    </section>
